...
- Do not make assumptions; verify with the user before taking steps based on them.
...
- After a feature is implemented and verified, commit that feature's changes with
  ...
  and ask for clarification only when the feature cannot be isolated safely.
